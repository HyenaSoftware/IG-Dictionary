...
import com.hyenawarrior.oldnorsedictionary.new_word.pages.{AddNewWordActivity, SetMeaningFragment}
import com.hyenawarrior.oldnorsedictionary.{MainActivity, R}
